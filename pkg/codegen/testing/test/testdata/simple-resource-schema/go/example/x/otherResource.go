...
func (o OtherResourceOutput) Foo() pux.GPtrOutput[Resource, ResourceOutput] {
	return pux.Apply(o, func(v *OtherResource) pux.GPtrOutput[Resource, ResourceOutput] { return v.Foo })
}
