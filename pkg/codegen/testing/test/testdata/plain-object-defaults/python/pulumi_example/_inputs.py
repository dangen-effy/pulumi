...
class HelmReleaseSettings:
    def __init__(__self__, *,
        ...
        """
        HelmReleaseSettings.__configure__(
...
class HelmReleaseSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        HelmReleaseSettingsArgs.__configure__(
            required_arg=required_arg,
            driver=driver,
            plugins_path=plugins_path,
            __setter=lambda key, value: pulumi.set(__self__, key, value),
...
class KubeClientSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        KubeClientSettingsArgs.__configure__(
            burst=burst,
            qps=qps,
            rec_test=rec_test,
            __setter=lambda key, value: pulumi.set(__self__, key, value),
...
class LayeredTypeArgs:
    ...
    def __configure__(*,
             ...
             recursive: Optional[pulumi.Input['LayeredTypeArgs']] = None,
             __setter=lambda key, value: ...):
        __setter("other", other)
        if thinker is None:
            thinker = 'not a good interaction'
        __setter("thinker", thinker)
        if answer is None:
            answer = 42
        if answer is not None:
            __setter("answer", answer)
        if plain_other is not None:
            __setter("plain_other", plain_other)
        if question is None:
            question = (_utilities.get_env('PULUMI_THE_QUESTION') or '<unknown>')
        if question is not None:
            __setter("question", question)
        if recursive is not None:
            __setter("recursive", recursive)
